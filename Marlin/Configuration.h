...
#define STRING_CONFIG_H_AUTHOR "(ablab, Ender 5+)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
// #define NOZZLE_TO_PROBE_OFFSET { -45, -7, 0 } // According to Keysey Fabrications
// #define NOZZLE_TO_PROBE_OFFSET { -44, -9, 0 } // According to TH3D
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, 0 } // According to me
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 50), (Y_MIN_POS + 10), 10 }
